...
class MSDPanel(wx.lib.scrolledpanel.ScrolledPanel):
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblProt = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblMSD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(25, 15), size=(270, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstMSD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, 45), size=(320, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblEntity = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblEntity.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(25, 70), size=(270, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblEntityInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstEntity.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, 100), size=(320, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoA = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnA.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(7, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoC = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnC.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(51, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoD = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(95, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoE = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnE.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(139, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoF = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnF.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(183, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoG = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnG.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(227, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoH = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnH.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(271, 130), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoI = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnI.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(7, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoK = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnK.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(51, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoL = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnL.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(95, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoM = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnM.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(139, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoN = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnN.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(183, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoP = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnP.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(227, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoQ = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnQ.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(271, 160), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoR = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnR.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(7, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoS = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnS.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(51, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoT = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnT.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(95, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoV = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnV.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(139, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoW = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnW.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(183, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoY = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnY.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(227, 190), size=(42, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAminoX = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnX.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(271, 190), size=(42, 25))
	else:
	...
	self.states = []
	if (platform.system() == "Darwin"):
	    self.btnAddEntity = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnAddEntity.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, 220), size=(100, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnRemoveEntity = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnRemoveEntity.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(220, 220), size=(100, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAddRes = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnAddRes.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(131, 540), size=(88, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnRemoveRes = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnRemoveRes.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(224, 540), size=(88, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblSecondary = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblSecondary.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(25, 570), size=(270, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblSecondaryInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstSecondary.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, 600), size=(320, 35))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAdd = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnAdd.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(7, 665), size=(57, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnRemove = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnRemove.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(69, 665), size=(57, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnRestrict = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnRestrict.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(131, 665), size=(57, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAll = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnAll.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(193, 665), size=(57, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnClear = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnClear.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(255, 665), size=(57, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblStates = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblStates.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(25, ypos), size=(270, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblStatesInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstStates.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, ypos+30), size=(320, 70))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.lblVectorInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstVector.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, ypos+10), size=(320, 50))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnMin = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnMin_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(165, ypos+60), size=(70, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnMax = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnMax.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(245, ypos+60), size=(70, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblFitness = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblFitness.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(25, ypos+90), size=(270, 25))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblFitnessInst = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblInstFitness.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, ypos+120), size=(320, 50))
	else:
	...
	if (platform.system() == "Windows"):
	    ...
	    self.lblStateLiteral = wx.StaticBitmap(self, -1, wx.Image("images/osx/lblStateLiteral.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(0, ypos+233), size=(160, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnAddOp = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnAddOp.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(165, ypos+260), size=(70, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnRemoveOp = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnRemoveOp.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(245, ypos+260), size=(70, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnLoadMSD = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnLoadMSD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(20, ypos+290), size=(120, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnSaveMSD = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnSaveMSD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(175, ypos+290), size=(120, 25))
	else:
	...
	if (platform.system() == "Darwin"):
	    self.btnMSD = wx.BitmapButton(self, id=-1, bitmap=wx.Image("images/osx/btnMSD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap(), pos=(100, ypos+320), size=(120, 25))
	else:
	...
	for i in range(1, ncols):
	    self.grdEntity.SetColSize(i, 90)
	...
	if (platform.system() == "Darwin"):
	    self.btnMin.SetBitmapLabel(bitmap=wx.Image("images/osx/btnMin_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    self.btnMax.SetBitmapLabel(bitmap=wx.Image("images/osx/btnMax.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	else:
	    self.btnMin.SetForegroundColour("#FF0000")
	    self.btnMax.SetForegroundColour("#000000")
	...
	if (platform.system() == "Darwin"):
	    self.btnMin.SetBitmapLabel(bitmap=wx.Image("images/osx/btnMin.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    self.btnMax.SetBitmapLabel(bitmap=wx.Image("images/osx/btnMax_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	else:
	    self.btnMin.SetForegroundColour("#000000")
	    self.btnMax.SetForegroundColour("#FF0000")
	...
	if ("A" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoA.SetBitmapLabel(bitmap=wx.Image("images/osx/btnA.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoA.SetForegroundColour("#000000")
	    logInfo("Removed ALA from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoA.SetBitmapLabel(bitmap=wx.Image("images/osx/btnA_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("C" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoC.SetBitmapLabel(bitmap=wx.Image("images/osx/btnC.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoC.SetForegroundColour("#000000")
	    logInfo("Removed CYS from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoC.SetBitmapLabel(bitmap=wx.Image("images/osx/btnC_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("D" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoD.SetBitmapLabel(bitmap=wx.Image("images/osx/btnD.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoD.SetForegroundColour("#000000")
	    logInfo("Removed ASP from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoD.SetBitmapLabel(bitmap=wx.Image("images/osx/btnD_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("E" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoE.SetBitmapLabel(bitmap=wx.Image("images/osx/btnE.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoE.SetForegroundColour("#000000")
	    logInfo("Removed GLU from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoE.SetBitmapLabel(bitmap=wx.Image("images/osx/btnE_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("F" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoF.SetBitmapLabel(bitmap=wx.Image("images/osx/btnF.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoF.SetForegroundColour("#000000")
	    logInfo("Removed PHE from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoF.SetBitmapLabel(bitmap=wx.Image("images/osx/btnF_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("G" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoG.SetBitmapLabel(bitmap=wx.Image("images/osx/btnG.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoG.SetForegroundColour("#000000")
	    logInfo("Removed GLY from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoG.SetBitmapLabel(bitmap=wx.Image("images/osx/btnG_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("H" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoH.SetBitmapLabel(bitmap=wx.Image("images/osx/btnH.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoH.SetForegroundColour("#000000")
	    logInfo("Removed HIS from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoH.SetBitmapLabel(bitmap=wx.Image("images/osx/btnH_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("I" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoI.SetBitmapLabel(bitmap=wx.Image("images/osx/btnI.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoI.SetForegroundColour("#000000")
	    logInfo("Removed ILE from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoI.SetBitmapLabel(bitmap=wx.Image("images/osx/btnI_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("K" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoK.SetBitmapLabel(bitmap=wx.Image("images/osx/btnK.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoK.SetForegroundColour("#000000")
	    logInfo("Removed LYS from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoK.SetBitmapLabel(bitmap=wx.Image("images/osx/btnK_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("L" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoL.SetBitmapLabel(bitmap=wx.Image("images/osx/btnL.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoL.SetForegroundColour("#000000")
	    logInfo("Removed LEU from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoL.SetBitmapLabel(bitmap=wx.Image("images/osx/btnL_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("M" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoM.SetBitmapLabel(bitmap=wx.Image("images/osx/btnM.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoM.SetForegroundColour("#000000")
	    logInfo("Removed MET from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoM.SetBitmapLabel(bitmap=wx.Image("images/osx/btnM_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("N" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoN.SetBitmapLabel(bitmap=wx.Image("images/osx/btnN.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoN.SetForegroundColour("#000000")
	    logInfo("Removed ASN from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoN.SetBitmapLabel(bitmap=wx.Image("images/osx/btnN_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("P" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoP.SetBitmapLabel(bitmap=wx.Image("images/osx/btnP.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoP.SetForegroundColour("#000000")
	    logInfo("Removed PRO from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoP.SetBitmapLabel(bitmap=wx.Image("images/osx/btnP_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("Q" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoQ.SetBitmapLabel(bitmap=wx.Image("images/osx/btnQ.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoQ.SetForegroundColour("#000000")
	    logInfo("Removed GLN from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoQ.SetBitmapLabel(bitmap=wx.Image("images/osx/btnQ_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("R" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoR.SetBitmapLabel(bitmap=wx.Image("images/osx/btnR.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoR.SetForegroundColour("#000000")
	    logInfo("Removed ARG from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoR.SetBitmapLabel(bitmap=wx.Image("images/osx/btnR_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("S" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoS.SetBitmapLabel(bitmap=wx.Image("images/osx/btnS.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoS.SetForegroundColour("#000000")
	    logInfo("Removed SER from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoS.SetBitmapLabel(bitmap=wx.Image("images/osx/btnS_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("T" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoT.SetBitmapLabel(bitmap=wx.Image("images/osx/btnT.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoT.SetForegroundColour("#000000")
	    logInfo("Removed THR from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoT.SetBitmapLabel(bitmap=wx.Image("images/osx/btnT_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("V" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoV.SetBitmapLabel(bitmap=wx.Image("images/osx/btnV.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoV.SetForegroundColour("#000000")
	    logInfo("Removed VAL from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoV.SetBitmapLabel(bitmap=wx.Image("images/osx/btnV_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("W" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoW.SetBitmapLabel(bitmap=wx.Image("images/osx/btnW.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoW.SetForegroundColour("#000000")
	    logInfo("Removed TRP from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoW.SetBitmapLabel(bitmap=wx.Image("images/osx/btnW_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
	...
	if ("Y" in self.palette):
	    if (platform.system() == "Darwin"):
		self.btnAminoY.SetBitmapLabel(bitmap=wx.Image("images/osx/btnY.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
		self.btnAminoY.SetForegroundColour("#000000")
	    logInfo("Removed TYR from palette")
	else:
	    if (platform.system() == "Darwin"):
		self.btnAminoY.SetBitmapLabel(bitmap=wx.Image("images/osx/btnY_Hi.png", wx.BITMAP_TYPE_PNG).ConvertToBitmap())
	    else:
